...
namespace RosanicSocial.Domain.DTO.Response.Statistics.Post {
    public class PostStatisticsGetResponse {
    ...
    public static partial class PostStatisticsEntityExtensions {
        public static PostStatisticsGetResponse ToGetResponse(this PostStatisticsEntity entity) {
            return new PostStatisticsGetResponse {
