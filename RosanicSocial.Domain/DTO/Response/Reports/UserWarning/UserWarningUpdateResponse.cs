...
namespace RosanicSocial.Domain.DTO.Response.Reports.UserWarning {
    public class UserWarningUpdateResponse {
    ...
    public static partial class UserWarningEntityExtensions {
        public static UserWarningUpdateResponse ToUpdateResponse(this UserWarningEntity entity) {
            return new UserWarningUpdateResponse {
                Id = entity.Id,
